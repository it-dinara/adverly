...
// In-memory хранилище для объявлений1
let items = [];
...
app.post("/items", (req, res) => {
  const { name, description, location, category, ...rest } = req.body;
  ...
  switch (category) {
    case ItemCategories.REAL_ESTATE:
...
app.use(express.static("dist")); // Ensure this is above API routes
